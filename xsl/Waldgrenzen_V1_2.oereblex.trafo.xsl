<xsl:stylesheet
        ...
        <TRANSFER xmlns="http://www.interlis.ch/INTERLIS2.3">
            ...
            <DATASECTION>
                <OeREBKRMtrsfr_V2_0.Transferstruktur BID="{$theme_code}">
                    ...
                    <xsl:apply-templates select="ili:Waldgrenzen_V1_2.Geobasisdaten/ili:Waldgrenzen_V1_2.Geobasisdaten.Geometrie_Dokument"/>
    ...
    <xsl:template match="ili:Waldgrenzen_V1_2.Geobasisdaten/ili:Waldgrenzen_V1_2.Geobasisdaten.Waldgrenze_Linie">
        ...
        <OeREBKRMtrsfr_V2_0.Transferstruktur.Geometrie TID="geometrie_{@TID}">
            <Linie> <!-- should be safe for Waldgrenzen (only Linie according to the model) -->
    ...
    <xsl:template match="ili:Waldgrenzen_V1_2.Geobasisdaten/ili:Waldgrenzen_V1_2.Geobasisdaten.Geometrie_Dokument">
