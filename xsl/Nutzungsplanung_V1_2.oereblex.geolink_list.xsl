<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ili:Nutzungsplanung_V1_2.Rechtsvorschriften/ili:Nutzungsplanung_V1_2.Rechtsvorschriften.Dokument">
        ...
        <xsl:apply-templates select="./ili:TextImWeb/ili:Nutzungsplanung_V1_2.MultilingualUri/ili:LocalisedText/ili:Nutzungsplanung_V1_2.LocalisedUri">
            <xsl:with-param name="doc_tid" select="$mgdm_original_tid"/>
        </xsl:apply-templates>
    </xsl:template>
    <xsl:template match="/ili:TRANSFER/ili:DATASECTION/ili:Nutzungsplanung_V1_2.Rechtsvorschriften/ili:Nutzungsplanung_V1_2.Rechtsvorschriften.Dokument/ili:TextImWeb/ili:Nutzungsplanung_V1_2.MultilingualUri/ili:LocalisedText/ili:Nutzungsplanung_V1_2.LocalisedUri">
