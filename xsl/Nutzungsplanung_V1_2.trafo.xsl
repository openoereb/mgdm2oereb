<xsl:stylesheet
    ...
    <xsl:template match="ili:Nutzungsplanung_V1_2.Rechtsvorschriften/ili:Nutzungsplanung_V1_2.Rechtsvorschriften.Dokument">
        ...
        <xsl:variable name="mgdm_amt" select="../../ili:Nutzungsplanung_V1_2.TransferMetadaten/ili:Nutzungsplanung_V1_2.TransferMetadaten.Amt/@TID"/> <!-- haven't found explicit connection to Amt or Datenbestand -->
