<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ili:Laermempfindlichkeitsstufen_V1_2.Rechtsvorschriften/ili:Laermempfindlichkeitsstufen_V1_2.Rechtsvorschriften.Dokument">
        ...
        <xsl:apply-templates select="./ili:TextImWeb/ili:Laermempfindlichkeitsstufen_V1_2.MultilingualUri/ili:LocalisedText/ili:Laermempfindlichkeitsstufen_V1_2.LocalisedUri">
            <xsl:with-param name="doc_tid" select="$mgdm_original_tid"/>
        </xsl:apply-templates>
    </xsl:template>
    <xsl:template match="/ili:TRANSFER/ili:DATASECTION/ili:Laermempfindlichkeitsstufen_V1_2.Rechtsvorschriften/ili:Laermempfindlichkeitsstufen_V1_2.Rechtsvorschriften.Dokument/ili:TextImWeb/ili:Laermempfindlichkeitsstufen_V1_2.MultilingualUri/ili:LocalisedText/ili:Laermempfindlichkeitsstufen_V1_2.LocalisedUri">
